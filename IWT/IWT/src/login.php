<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($username=="test"&&$password=="1234"){
            ...
            echo "<script>alert('You have entered the incorrect 
			Username or the Password')</script>";
        }
    }
?>
<!DOCTYPE html>
...
<hr id="test"/>
<center>
<h3 style="font-weight: bold; font-style: italic;">Created By :Kalani Kasthuriarachchi</h3>
