...
<center>
    <?php
    //1
    define("companyName","Shopping Cart"); //Create a constant to store the web site name
	//2
    echo "<h2>About ".companyName."</h2><br>"; //Print “About (Company Name)” header (use <h2>) using echo
	//3
    ...
    for($x = 0;$x < count($keys);$x++){
        echo "<tr>
				<td>
					<center>".$keys[$x] ."</center>
				</td>
				<td>
					<center>".$items[$keys[$x]]."</center>
				</td>
			</tr>";
    }
